...
-- 1 se creo el usuario al principio
--  2 se crearon productos
-- 3. Insertar dirección del usuario
INSERT INTO domicilio(id_cliente, domicilio)
VALUES (1, 'Av. Siempre Viva 742');

-- 4. Crear carrito para Jazmin
...
VALUES 
(1, 1, 2),  -- remera negra talle S de mujer
(1, 2, 1);  -- remera azul talle S de mujer

-- 6. Crear pedido a partir del carrito
INSERT INTO pedido(id_cliente, id_domicilio , total, estado)
VALUES (1, 1, 16500, 'pendiente');

-- 7. Registrar items del pedido (histórico de precios)
INSERT INTO pedidoXitem(id_pedido, id_producto, cantidad, precioxunidad)
VALUES
(1, 1, 2, 5500),  -- 2 remera negra talle S de mujer
(1, 2, 1, 5500); -- 1 remera azul talle S de mujer
